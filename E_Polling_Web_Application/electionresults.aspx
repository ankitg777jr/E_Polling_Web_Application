<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="electionresults.aspx.cs" Inherits="E_Polling_Web_Application.WebForm15" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered table-responsive-md" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="candidate_id" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Candidate Profile" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle">
                                            <ItemTemplate>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("candidate_name") %>' Font-Size="Larger" Font-Bold="True"></asp:Label>
                                                        </div>
                                                        <div class="col-lg-4">
                                        ...
                                        <asp:TemplateField HeaderText="Votes" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle">
                                            <ItemTemplate>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col">
                                                            <br>
                                                            <asp:Label ID="Label1" runat="server" Text="Vote Count" Font-Size="Larger" Font-Bold="True"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
